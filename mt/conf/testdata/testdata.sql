...
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Seventeen Years', 1, 121822, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Spanish Armada', 2, 121822, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Germany To Germany', 1, 121823, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Noose', 2, 121823, now(), now());
...
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Intro', 1, 404052, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('When You Hear That', 2, 404052, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Hot', 3, 404052, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Smith Bros.', 4, 404052, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Get Em High', 5, 404052, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Stunt 101', 6, 404052, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Fix Up', 7, 404052, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('PLO Style', 8, 404052, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Freestyle', 9, 404052, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Cutting It Up', 10, 404052, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Dirty Ryders', 11, 404052, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Sunshine', 12, 404052, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Wake Up', 13, 404052, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Run', 14, 404052, now(), now());
...
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Shempi', 1, 322878, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Shempi (E\'Rock Remix)', 2, 322878, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Shempi (Zongamin Remix)', 3, 322878, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Shiller', 1, 230271, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Mahalo', 2, 230271, now(), now());
insert into {{{prefix}}}songs (title, track_no, album_id, date_created, date_modified) values ('Pursuit Of Happiness', 1, 647366, now(), now());
